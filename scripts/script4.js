// Javascript pour le carrousel d'images
let index = 1;
montrer(index);
...
function montrer(n) {
  let i;
  let diapos = document.getElementsByClassName("image");
  if (n > diapos.length) {index = 1}
  if (n < 1) {index = diapos.length}
